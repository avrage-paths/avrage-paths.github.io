...
//This class was taken from https://github.com/sinbad/UnityCsvUtil
//And is covered through free use as stated at the bottom of the page 

//When we save data, it will overwrite if the csv already exists. 


namespace Sinbad
{
    /// <summary>
    /// Class for easy reading and writting of CSV's gathered from https://github.com/sinbad/UnityCsvUtil
    ///And is covered through free use as stated at the bottom of the page 
    ...
    public static class CsvUtil
    {
        ...
        /// <param name="strict"> If true, log errors if a line doesn't have enough
        ///   fields as per the header. If false, ignores and just fills what it can</param>
        ...
        /// Field names are matched case-insensitive for convenience
        /// </summary>
        /// <param name="rdr">Input reader</param>
        /// <param name="strict">If true, log errors if a line doesn't have enough
        ///   fields as per the header. If false, ignores and just fills what it can</param>
        ...
        /// <param name="destObject">A reference to the object to be populated</param>
        ...
        /// </summary>
        /// <param name="rdr">Input Reader</param>
        /// <param name="destObject">A refrence to the object to be populated</param>
        ...
        /// </summary>
        /// <param name="obj">The object to save</param>
        /// <param name="w"> The text writter</param>
        ...
        /// This method throws exceptions if unable to write
        /// </summary>
        /// <param name="objs">A enumerable list of objects to save</param>
        /// <param name="filename">The filename to save them too</param>
        ...
        /// This method throws exceptions if unable to write
        /// </summary>
        /// <param name="objs">An enumerable list of objects to save</param>
        /// <param name="w">The text writter</param>
        public static void SaveObjects<T>(IEnumerable<T> objs, TextWriter w)
        {
            ...
            foreach (T obj in objs)
            {
                ...
                if (firstLine)
                {
                    ...
                    WriteHeader(fields, w);
                    firstLine = false;
                }
                else
                    w.Write(Environment.NewLine);

                WriteObjectToLine(obj, fields, w);

            }
        }

        /// <summary>
        /// Helper function to write the header
        /// </summary>
        /// <param name="fi">The field information for the header</param>
        /// <param name="w">The text writter</param>
        private static void WriteHeader(FieldInfo[] fi, TextWriter w)
        {
            bool firstCol = true;
            foreach (FieldInfo f in fi)
            {
        ...
        /// <summary>
        /// Helper for writting a single object to a row 
        /// </summary>
        /// <param name="obj">The object to write</param>
        /// <param name="fi">The field info for the csv</param>
        /// <param name="w">The textwritter</param>
        ...
        /// </summary>
        /// <param name="line">The line we're parsing</param>
        /// <param name="fieldDefs">The definitions for the fields</param>
        /// <param name="fi">The field information</param>
        /// <param name="pi">The property information</param>
        /// <param name="destObject">The object we want to write to</param>
        /// <param name="strict">If true, log errors if a line doesn't have enough
        ///   fields as per the header. If false, ignores and just fills what it can</param>
        /// <returns>if any were set</returns>
        ...
        /// <summary>
        /// Sets a given field in the object we're loading 
        /// </summary>
        /// <param name="fieldName">The field we're setting</param>
        /// <param name="val">The value we're setting it to</param>
        /// <param name="fi">The field information</param>
        /// <param name="pi">The property information</param>
        /// <param name="destObject">The object we're writting to</param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Wrapper function for parsing string
        /// </summary>
        /// <param name="strValue">The string we're parsing</param>
        /// <param name="t">The type of object we're expecting</param>
        /// <returns>Correct object based on string</returns>
        ...
        /// </summary>
        /// <param name="strValue">The string we want to remove spaces from</param>
